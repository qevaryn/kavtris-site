...
export function ProductEvolution({ product, levelId }: ProductEvolutionProps) {
  return (
    <section data-testid="product-evolution" className="bg-white py-14 sm:py-16 lg:py-20">
          ...
          {product.levels.map((level, index) => {
            ...
            return (
              <li
                ...
                className={cn(
                  'relative flex flex-col rounded-[1.35rem] border p-6 shadow-sm transition sm:p-7',
                  isSelected
              ...
              >
                ...
                <h3 className="mt-5 text-xl font-semibold text-navy-950">{level.name}</h3>
