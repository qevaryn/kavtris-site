        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {conceptProducts.map((product) => (
            <article key={product.name} className="rounded-[1.35rem] border border-borderline bg-paper p-5 shadow-sm">
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-gold-600">Conceito</p>
              ...
              <p className="mt-4 rounded-2xl border border-gold-600/20 bg-white px-4 py-3 text-xs font-semibold leading-5 text-navy-800">
