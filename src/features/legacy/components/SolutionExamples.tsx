          ...
          {solutionExamples.map((solution) => {
            ...
            return (
              <article key={solution.title} className="rounded-[1.35rem] border border-borderline bg-paper p-5 shadow-sm">
                <p className="text-sm font-extrabold leading-6 text-kavtris-blue">{solution.problem}</p>
                ...
                <button
                  type="button"
                  className="mt-5 flex min-h-11 w-full items-center justify-between rounded-2xl border border-borderline bg-white px-4 text-sm font-semibold text-navy-800 transition hover:border-kavtris-blue focus:outline-none focus-visible:ring-2 focus-visible:ring-kavtris-blue"
