      ...
      <main className="bg-paper">
        ...
        <section className="bg-navy-950 py-12 text-white sm:py-16">
          <div className="container-section grid gap-8 lg:grid-cols-[0.58fr_0.42fr] lg:items-center">
            ...
            <div className="rounded-[1.6rem] border border-white/10 bg-white/[0.04] p-5 shadow-2xl">
              ...
              <div className="mt-5 grid gap-2">
                {helpApproaches.map(({ title, description, icon: Icon }) => (
                  <div key={title} className="rounded-2xl bg-navy-900/80 p-3.5 transition hover:bg-navy-900">
              ...
              <p className="mt-5 border-t border-white/10 pt-4 text-sm leading-6 text-white/58">
        ...
        <section id="problemas-reconhecidos" className="bg-white py-14 sm:py-16">
          <div className="container-section grid gap-8 lg:grid-cols-[0.36fr_0.64fr] lg:items-start">
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-5 rounded-2xl border border-kavtris-blue/25 bg-[#EAF1FC] p-4 text-sm leading-6 text-navy-800">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {enterpriseFitScenarios.map((scenario) => (
                <article
                  key={scenario}
                  className="flex gap-3 rounded-[1.25rem] border border-borderline bg-paper p-4 shadow-sm transition hover:border-kavtris-blue/40"
                >
        ...
        <section id="como-trabalhamos" className="bg-mist py-14 sm:py-16">
          <div className="container-section">
            ...
            <div className="relative mt-6 grid gap-5 lg:grid-cols-4">
              {/* Progression line connecting the numbered nodes (desktop). */}
              <div
                aria-hidden="true"
                className="absolute inset-x-6 top-[2.375rem] hidden h-0.5 rounded-full bg-kavtris-blue/20 lg:block"
              />
              {enterpriseDeliveryStages.map((stage, index) => (
                <article key={stage.id} className="relative rounded-[1.35rem] border border-borderline bg-white p-5 shadow-sm">
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
              {enterpriseFoundations.map((pillar, index) => {
                ...
                return (
                  <article
                    key={pillar.id}
                    className="rounded-[1.35rem] border border-borderline bg-paper p-5 shadow-sm transition hover:border-kavtris-blue/40"
                  >
        ...
        <section id="capacidades" className="bg-paper py-14 sm:py-16">
          <div className="container-section">
            <div className="grid gap-6 lg:grid-cols-[0.36fr_0.64fr] lg:items-start">
              ...
              <div className="grid gap-3">
                {enterpriseCapabilities.map((group) => (
                  <details
                    key={group.id}
                    className="group rounded-[1.35rem] border border-borderline bg-white p-5 shadow-sm transition open:border-kavtris-blue/40 open:shadow-card sm:p-5"
                  >
        ...
        <section className="bg-white py-14 sm:py-16">
          <div className="container-section">
            ...
            <div className="mt-6 rounded-[1.35rem] border border-borderline bg-paper p-5">
              <div className="flex items-center gap-3">
          ...
          <div className="container-section">
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
              {commercialClarityItems.map((item) => (
                <article key={item.id} className="rounded-[1.35rem] border border-borderline bg-white p-5 shadow-sm">
                  <h3 className="text-lg font-semibold text-navy-950">{item.title}</h3>
                  <p className="mt-3 text-sm leading-6 text-slate-600">{item.description}</p>
                </article>
              ))}
            </div>
            <div className="mt-6 rounded-[1.35rem] border border-kavtris-blue/25 bg-white p-4 text-sm leading-7 text-slate-600 shadow-sm">
              <p>
        ...
        {/* 8 — Trust */}
        <section className="bg-white py-14 sm:py-16">
          <div className="container-section grid gap-6 lg:grid-cols-[0.4fr_0.6fr] lg:items-start">
            <div>
          ...
          <div className="container-section">
            ...
            <div className="mt-8 grid gap-5 lg:grid-cols-3">
              ...
              <article
                ...
                className="flex flex-col rounded-[1.5rem] border border-kavtris-blueLight/60 bg-navy-950 p-6 text-white shadow-glow sm:p-6"
              >
                ...
                <Button href="/#contacto" className="mt-auto sm:mt-6">
                  Falar com um consultor
              ...
              <article
                ...
                className="flex flex-col rounded-[1.5rem] border border-borderline bg-white p-6 text-navy-950 shadow-sm transition hover:border-kavtris-blue/50 sm:p-6"
              >
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-kavtris-blue">
                  Não sei qual sistema preciso
                </p>
                <h3 className="mt-3 font-display text-2xl leading-tight text-navy-950 sm:text-3xl">
              ...
              {/* SECONDARY — system catalog. WEB.1F.7: strong dark navy contour
                  on card and CTA (same design-system language as the homepage
                  and /produtos selector). */}
              <article
                data-testid="engineering-final-systems"
                className="flex flex-col rounded-[1.5rem] border border-navy-900/40 bg-[#EAF1FC] p-6 text-navy-950 shadow-sm transition hover:border-kavtris-blue/70 sm:p-6"
              >
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-kavtris-blue">
                ...
                <p className="mt-3 text-sm leading-7 text-navy-800/80 sm:text-base">
