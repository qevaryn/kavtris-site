...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <article
      ...
      className="group flex h-full flex-col overflow-hidden rounded-[1.35rem] border border-borderline bg-white shadow-sm transition hover:-translate-y-1 hover:border-kavtris-blue/40 hover:shadow-card motion-reduce:transition-none motion-reduce:hover:translate-y-0"
    >
      <figure
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy-950/80 to-transparent p-4">
          <span className="inline-flex rounded-full border border-white/15 bg-navy-950/70 px-3 py-1 text-[0.68rem] font-bold uppercase tracking-[0.16em] text-kavtris-blueLight backdrop-blur">
            Demonstração visual
          </span>
        </div>
      </figure>
