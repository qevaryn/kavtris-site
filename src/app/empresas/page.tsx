...
import { ArrowRight, CheckCircle2, ClipboardCheck, FileText, GitBranch, ShieldCheck, TestTube2 } from 'lucide-react';
      ...
      <main className="bg-paper">
          ...
          <div className="container-section grid gap-8 lg:grid-cols-[0.58fr_0.42fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Button href="#capacidades" variant="secondary">
                  Ver capacidades
                </Button>
              </div>
            </div>
            ...
            <div className="rounded-[1.6rem] border border-white/10 bg-white/[0.04] p-6 shadow-2xl">
              ...
              <div className="mt-6 grid gap-3">
                {[
                  ...
                  ['Segurança', 'acessos e dados por escopo'],
                  ['Qualidade', 'testes e validação progressiva'],
                  ['Continuidade', 'documentação e suporte acordados']
                ].map(([label, value]) => (
                  <div key={label} className="rounded-2xl bg-navy-900/80 p-4">
                    <p className="text-sm font-bold text-white">{label}</p>
                    <p className="mt-1 text-sm text-white/64">{value}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="bg-navy-950 py-16 text-white sm:py-20">
          <div className="container-section rounded-[1.6rem] border border-white/10 bg-white/5 p-6 sm:p-8">
            <h2 className="max-w-3xl text-3xl font-semibold tracking-tight">Vamos entender os requisitos do seu projeto?</h2>
            <p className="mt-4 max-w-3xl text-base leading-8 text-white/72">
              Explique o processo, os sistemas envolvidos e o que precisa de melhorar. A primeira conversa ajuda a definir um ponto de partida realista.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button href="/?tipo=empresa#contacto" className="text-navy-950">
                Falar sobre requisitos
