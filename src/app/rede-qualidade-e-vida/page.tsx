      ...
      <main className="bg-paper">
        <section className="bg-navy-950 py-16 text-white sm:py-20">
          <div className="container-section">
            ...
            />
            <p className="mt-8 text-xs font-semibold uppercase tracking-[0.28em] text-kavtris-blueLight">Rede Qualidade é Vida</p>
            ...
            <p className="mt-6 max-w-3xl rounded-2xl border border-kavtris-blue/20 bg-white/5 p-4 text-sm leading-7 text-white/72">
        ...
        <section className="py-16 sm:py-20">
          <div className="container-section">
            ...
            <Link href="/" className="mt-10 inline-flex text-sm font-semibold text-kavtris-blue underline-offset-4 hover:underline">
              Voltar à KAVTRIS
            </Link>
          </div>
        </section>
