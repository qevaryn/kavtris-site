...
```mermaid
graph TD
    R[Rede Qualidade é Vida]
    R --> Q[Qevaryn Systems — tecnologia]
    R --> C[Qualidade é Vida Care]
    R --> CL[Qualidade é Vida Clean]
    R --> M[Qualidade é Vida Mobility]
    R --> A[Qualidade é Vida Academy]
    R --> CO[Qualidade é Vida Consulting]
    R --> F[futuras empresas autorizadas]
```
