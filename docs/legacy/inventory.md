...
| `src/features/legacy/components/Experience.tsx` | Earlier experience/project section. | Shared project card. | None confirmed. | None direct. | `src/data/projects`. | Founder/company proof reference. | Medium. | retain-future-review |
| `src/features/legacy/components/Founder.tsx` | Earlier founder section. | Shared UI, image. | None confirmed. | None direct. | `socialLinks`. | Personal credibility content. | Medium. | retain-future-review |
...
| `src/features/legacy/components/InteractiveProductDemo.tsx` | Earlier interactive demo. | Shared UI. | None confirmed. | None direct. | `src/data/product-demos`. | Product demo patterns. | Medium. | retain-future-review |
| `src/features/legacy/components/Network.tsx` | Earlier network section. | Layout logo, shared UI. | None confirmed. | None direct. | `src/data/network`. | Rede Qualidade e Vida messaging. | Medium. | retain-future-review |
| `src/features/legacy/components/Problems.tsx` | Earlier problem cards. | Shared UI. | None confirmed. | None direct. | `src/data/problems`. | Problem taxonomy reference. | Low. | retain-future-review |
...
| `src/features/legacy/components/Services.tsx` | Earlier services accordion/cards. | Shared UI. | None confirmed. | None direct. | `src/data/services`. | Services taxonomy reference. | Medium. | retain-future-review |
